...
class MultiScaleBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        # Split output channels across 3 convs, ensuring total = out_channels
        c_small = out_channels // 3
        c_medium = out_channels // 3
        c_large = out_channels - (c_small + c_medium)  # absorbs remainder
        
        self.conv_small = nn.Conv1d(in_channels, c_small, kernel_size=3, padding=1)
        self.conv_medium = nn.Conv1d(in_channels, c_medium, kernel_size=7, padding=3)
        self.conv_large = nn.Conv1d(in_channels, c_large, kernel_size=15, padding=7)
